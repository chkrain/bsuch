...
dwater_1 = Dosator(m = water_m_1.get_m, closed = io.DWATER_CLOSED_1, out = io.DWATER_OPEN_1, lock=Lock(key=lambda: io.ACCIDENT or io.POWERFAIL), containers=(water_1,))
...
if platform=='linux':
  ...
  instances += (imotor_1,igate_1,iauger_1,iauger_2,iwpump_1,iapump_1,iapump_2,iconveyor_1,itconveyor_1,idcement_1,idwater_1,idadditions_1,ifeeder_1,ifeeder_2,
